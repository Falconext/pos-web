                    ...
                    {isLoading ? (
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <div className="rounded-xl border border-gray-100 dark:border-slate-800 bg-gradient-to-br from-blue-50 to-blue-100/50 dark:from-blue-900/20 dark:to-blue-900/10 p-3 text-center">
                                ...
                                <div className="rounded-xl border border-gray-100 dark:border-slate-800 bg-gradient-to-br from-violet-50 to-violet-100/50 dark:from-violet-900/20 dark:to-violet-900/10 p-3 text-center">
                                ...
                                <div className="rounded-xl border border-gray-100 dark:border-slate-800 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-900/10 p-3 text-center">
                            ...
                            {/* Gráfico evolución */}
                            {chartData.length > 0 && (
                                <div className="rounded-xl border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900/40 p-4">

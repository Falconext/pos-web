...
interface Props {
    ...
    /**
     * Deja elegir variantes sin stock (cotizaciones y empresas con sobreventa).
     * El stock se sigue mostrando: solo se quita el bloqueo.
     */
...
const ModalSeleccionVariante = ({ isOpen, onClose, product, onSelect, permitirSinStock = false }: Props) => {
                    ...
                    {variantes.map((v: any) => {
                        ...
                        return (
                            <button
                                ...
                                type="button"
                                disabled={bloqueado}
                                onClick={() => !bloqueado && onSelect(product, v)}

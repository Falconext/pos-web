...
export const usePerfilViewModel = () => {
    ...
    const handleControlFlagToggle = async (
        flag: 'requiereAprobacionGastos' | 'requiereAprobacionCompras' | 'requiereCajaParaEmitir' | 'catalogoPorSede' | 'kitsComoUnaLinea' | 'paquetesComoUnaLinea' | 'posMantenerBusqueda',
        enabled: boolean,
    ) => {

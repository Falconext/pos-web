...
export const ProductSedesDisponibles: React.FC<{ vm: ViewProps }> = ({ vm }) => {
    ...
    return (
        <div className="col-span-1 md:col-span-2">
            <div className="rounded-xl border border-violet-100 dark:border-violet-900/40 bg-gradient-to-br from-white to-violet-50/30 dark:from-slate-800/60 dark:to-violet-950/20 p-4">
                <div className="flex items-start justify-between gap-3 mb-3">
                    <div>
                        <h5 className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2">
                            <Icon icon="solar:shop-2-bold-duotone" width={16} height={16} className="text-violet-600" />
                            Disponible en
                        </h5>
                        ...
                        return (
                            <label
                                ...
                                className={`flex items-center gap-2 rounded-lg border px-3 py-2 text-xs font-semibold shadow-sm transition-colors ${
                                    marcada
                                        ? 'border-violet-200 bg-white text-gray-800 dark:border-violet-800 dark:bg-slate-900 dark:text-gray-100'

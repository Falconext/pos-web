...
export const ProductWholesalePricing: React.FC<{ vm: ViewProps }> = ({ vm }) => {
    ...
    return (
        <div className="col-span-2 mt-4 p-4 rounded-xl border border-gray-200">
            <div className="flex items-center gap-2 mb-4">
                <div className="p-1 bg-green-500 rounded-lg">
                    <Icon icon="mdi:tag-multiple" className="text-white" width={20} height={20} />
                </div>
                <div>
                    <h4 className="text-lg font-[400] text-gray-900 leading-none">Precios por Cantidad / Mayorista</h4>
            ...
            <div className="bg-white border rounded-lg overflow-hidden">
                <div className="grid grid-cols-12 gap-2 p-3 border-b border-gray-100 text-xs font-[400] text-gray-500 uppercase tracking-wider">

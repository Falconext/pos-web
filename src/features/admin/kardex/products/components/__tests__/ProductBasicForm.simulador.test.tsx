...
jest.mock('@/zustand/auth', () => ({ useAuthStore: (sel: any) => sel({ auth: { rol: 'ADMIN_EMPRESA', ocultarPrecioCosto: false } }) }));
...
jest.mock('@/components/Date', () => ({ Calendar: () => null }));
...
jest.mock('../ModalEtiquetasBarras', () => ({ __esModule: true, default: () => null }));

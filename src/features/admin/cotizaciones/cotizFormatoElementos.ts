...
export const COTIZ_ELEMENTOS: ElemDef[] = [
  ...
  // texto por defecto ("GRACIAS POR ELEGIR <empresa> PARA CUBRIR SUS REQUERIMIENTOS
  // DE <rubro>" + "VUELVA PRONTO"). Admite varias líneas.
...
/**
 * Parte un texto libre en líneas para imprimirlo como lista de puntos. El

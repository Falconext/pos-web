import MayeCheckout from '@/pages/tienda/MayeCheckout';
...
export default function MayeCheckoutPage(props: TemplateCheckoutPageProps) {
  return (
    <>
      <MayeCheckout {...props} carrito={props.carritoState} />
      {props.pedidoCreado && (

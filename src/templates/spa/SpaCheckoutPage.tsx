            ...
            <motion.div initial="hidden" whileInView="show" viewport={spaViewport} variants={spaCard} className="rounded-3xl border border-black/[0.05] bg-white p-6 md:p-8">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <label className="block md:col-span-2">
                  ...
                  <textarea name="observaciones" value={formData.observaciones || ''} onChange={handleChange} rows={3} className="mt-2 w-full resize-none rounded-xl border border-neutral-200 bg-white px-4 py-4 text-sm text-neutral-900 outline-none transition-colors focus:border-[var(--spa-cp)]" placeholder="¿Es para regalo? Déjanos una dedicatoria o referencia..." />
                </label>
              </div>
            </motion.div>

import GadgetsCheckout from '@/pages/tienda/GadgetsCheckout';
...
export default function GadgetsCheckoutPage(props: TemplateCheckoutPageProps) {
  return (
    <>
      <GadgetsCheckout {...props} carrito={props.carritoState} />
      {props.pedidoCreado && (
      ...
      <ConfirmOrderModal
        ...
        tiendaColor={props.tienda?.diseno?.colorPrimario || '#6A6CFF'}
      />
    </>
  );
}

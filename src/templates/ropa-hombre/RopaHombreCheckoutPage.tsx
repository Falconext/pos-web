            ...
            <motion.div initial="hidden" whileInView="show" viewport={urbViewport} variants={urbCard} className="rounded-2xl border bg-white p-6 md:p-8" style={{ borderColor: URB.line }}>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <label className="block md:col-span-2">
                  ...
                  <textarea name="notaPedido" value={formData.notaPedido || ''} onChange={handleChange} rows={3} className="mt-2 w-full resize-none rounded-xl border border-neutral-200 bg-white px-4 py-4 text-sm text-neutral-900 outline-none transition-colors focus:border-[var(--urb-cp)]" placeholder="¿Talla, color o alguna referencia? Déjanos una nota..." />
                </label>
              </div>
            </motion.div>

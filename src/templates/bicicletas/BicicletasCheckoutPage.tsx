            ...
            <motion.div initial="hidden" whileInView="show" viewport={veloViewport} variants={veloCard} className="border bg-white p-6 md:p-8" style={{ borderColor: VELO.line }}>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="block md:col-span-2">
                  ...
                  <MedioPagoSelector configPago={configPago} value={formData.medioPago} onChange={handleChange} accent={primary} radius="0px" className="mt-2" />
                </div>
                <label className="block md:col-span-2">
                ...
                <label className="block md:col-span-2">
                  ...
                  <textarea name="observaciones" value={formData.observaciones || ''} onChange={handleChange} rows={3} className="mt-2 w-full resize-none border border-neutral-200 bg-white px-4 py-4 text-sm text-neutral-900 outline-none transition-colors focus:border-[var(--velo-cp)]" placeholder="¿Talla del ciclista, altura, referencia de entrega...?" />
                </label>
              </div>
            </motion.div>

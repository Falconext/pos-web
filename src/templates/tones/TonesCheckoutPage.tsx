            ...
            <motion.div initial="hidden" whileInView="show" viewport={tnViewport} variants={tnCard} className="rounded-[22px] border p-6 md:p-8" style={{ backgroundColor: TN.panel, borderColor: TN.line }}>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <label className="block md:col-span-2">
                  ...
                  <textarea name="observaciones" value={formData.observaciones || ''} onChange={handleChange} rows={3} className="mt-2 w-full resize-none rounded-xl border border-neutral-200 bg-white px-4 py-4 text-sm text-neutral-900 outline-none transition-colors focus:border-[var(--tn-cp)]" placeholder="¿Talla, color o alguna referencia? Cuéntanos aquí..." />
                </label>
              </div>
            </motion.div>

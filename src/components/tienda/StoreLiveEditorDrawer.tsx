  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        {results.length > 0 && (
          <div className="absolute z-20 mt-1 w-full rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-[#111827] shadow-lg max-h-56 overflow-y-auto">
            {results.map(p => (
              <button
                key={p.id}
  ...
  return (
    <div className="rounded-xl border border-gray-100 dark:border-slate-800 p-3">
      ...
      <div className="relative">
        ...
        {searching && <Icon icon="svg-spinners:ring-resize" className="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400" />}
        {results.length > 0 && (
          <div className="absolute z-10 mt-1 w-full rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-[#111827] shadow-lg max-h-56 overflow-y-auto">
            {results.map(p => (

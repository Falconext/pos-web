...
export const CONSTRUCCION_IMAGE_FIELDS: ImageFieldDef[] = [
  { key: 'construccionHeroImageUrl', label: 'Hero principal (portada)', hint: 'Imagen grande de la portada (fondo oscuro con herramientas). Recomendado 1200×600px.', fallback: '/assets/templates/ferreteria/banner.png' },
  { key: 'construccionPromoOneImageUrl', label: 'Promo 1 (izquierda)', hint: 'Tarjeta promocional izquierda. Recomendado 600×400px.', fallback: '/assets/templates/ferreteria/widgetferreteria1.png' },
  { key: 'construccionPromoTwoImageUrl', label: 'Promo 2 (central)', hint: 'Tarjeta promocional central. Recomendado 600×400px.', fallback: '/assets/templates/ferreteria/widgetferreteria2.png' },
  { key: 'construccionPromoThreeImageUrl', label: 'Promo 3 (derecha)', hint: 'Tarjeta promocional derecha. Recomendado 600×400px.', fallback: '/assets/templates/ferreteria/widgetferreteria3.png' },
  { key: 'construccionWideBannerImageUrl', label: 'Banner ancho (campaña)', hint: 'Campaña central grande de ancho completo. Recomendado 1400×360px.', fallback: '/assets/templates/ferreteria/oferta.png' },
  { key: 'construccionHalfBannerOneImageUrl', label: 'Banner inferior 1 (izquierda)', hint: 'Campaña inferior izquierda. Recomendado 700×320px.', fallback: '/assets/templates/ferreteria/oferta1.png' },
  { key: 'construccionHalfBannerTwoImageUrl', label: 'Banner inferior 2 (derecha)', hint: 'Campaña inferior derecha. Recomendado 700×320px.', fallback: '/assets/templates/ferreteria/oferta2.png' },
];
...
const ABARROTES_TEXT_FIELDS: TextFieldDef[] = [
  ...
  { key: 'abarrotesHeroTitle2', label: 'Slide 1: título (línea 2, color)', placeholder: 'mejor calidad y precio', group: 'Slider · Slide 1' },
  { key: 'abarrotesHeroSubtitle', label: 'Slide 1: subtítulo', placeholder: 'Preparamos descuentos especiales para ti en tus abarrotes...', group: 'Slider · Slide 1' },
  { key: 'abarrotesHeroPrice', label: 'Slide 1: precio/etiqueta', placeholder: 'Desde S/ 21.67', group: 'Slider · Slide 1' },
  { key: 'abarrotesHeroButton', label: 'Slide 1: botón', placeholder: 'Comprar ahora', group: 'Slider · Slide 1' },
  { key: 'abarrotesSlide2OnlyImage', label: 'Slide 2: solo imagen', placeholder: '', group: 'Slider · Slide 2', type: 'toggle', hint: 'Banner de solo imagen clickeable al destino del Slide 2.' },
  { key: 'abarrotesSlide2Eyebrow', label: 'Slide 2: etiqueta', placeholder: 'Solo esta semana', group: 'Slider · Slide 2' },
  { key: 'abarrotesSlide2Title', label: 'Slide 2: título (línea 1)', placeholder: 'Frescos todos', group: 'Slider · Slide 2' },
  { key: 'abarrotesSlide2Title2', label: 'Slide 2: título (línea 2, color)', placeholder: 'los días', group: 'Slider · Slide 2' },
  { key: 'abarrotesSlide2Subtitle', label: 'Slide 2: subtítulo', placeholder: 'Frutas, verduras y lácteos recién llegados...', group: 'Slider · Slide 2' },
  { key: 'abarrotesSlide2Price', label: 'Slide 2: precio/etiqueta', placeholder: 'Hasta 30% OFF', group: 'Slider · Slide 2' },
  { key: 'abarrotesSlide2Button', label: 'Slide 2: botón', placeholder: 'Ver ofertas', group: 'Slider · Slide 2' },
  { key: 'abarrotesSlide3OnlyImage', label: 'Slide 3: solo imagen', placeholder: '', group: 'Slider · Slide 3', type: 'toggle', hint: 'Banner de solo imagen clickeable al destino del Slide 3.' },
  { key: 'abarrotesSlide3Eyebrow', label: 'Slide 3: etiqueta', placeholder: 'Envío gratis', group: 'Slider · Slide 3' },
  { key: 'abarrotesSlide3Title', label: 'Slide 3: título (línea 1)', placeholder: 'Tu despensa llena,', group: 'Slider · Slide 3' },
  { key: 'abarrotesSlide3Title2', label: 'Slide 3: título (línea 2, color)', placeholder: 'sin salir de casa', group: 'Slider · Slide 3' },
  { key: 'abarrotesSlide3Subtitle', label: 'Slide 3: subtítulo', placeholder: 'Haz tu pedido y recíbelo el mismo día...', group: 'Slider · Slide 3' },
  { key: 'abarrotesSlide3Price', label: 'Slide 3: precio/etiqueta', placeholder: 'Envío gratis desde S/ 80', group: 'Slider · Slide 3' },
  { key: 'abarrotesSlide3Button', label: 'Slide 3: botón', placeholder: 'Comprar ahora', group: 'Slider · Slide 3' },
  { key: 'abarrotesEditorsTitle', label: 'Título "Selección destacada"', placeholder: 'Selección destacada', group: 'Secciones' },
  { key: 'abarrotesBestsellersTitle', label: 'Título "Más vendidos"', placeholder: 'Los más vendidos', group: 'Secciones' },
  { key: 'abarrotesPromoOneLabel', label: 'Promo 1: etiqueta', placeholder: 'Solo por hoy', group: 'Banner promo' },
  { key: 'abarrotesPromoOneTitle', label: 'Promo 1: título', placeholder: 'Haz tu compra fácil con nosotros', group: 'Banner promo' },
  { key: 'abarrotesPromoOneButton', label: 'Promo 1: botón', placeholder: 'Comprar ahora', group: 'Banner promo' },
  { key: 'abarrotesPromoTwoLabel', label: 'Promo 2: etiqueta', placeholder: 'Esta semana', group: 'Banner promo' },
  { key: 'abarrotesPromoTwoTitle', label: 'Promo 2: título', placeholder: 'Todo lo que tu hogar necesita', group: 'Banner promo' },
  { key: 'abarrotesPromoTwoButton', label: 'Promo 2: botón', placeholder: 'Comprar ahora', group: 'Banner promo' },
  { key: 'abarrotesSafetyTitle', label: 'Banda salud: título', placeholder: 'En tienda o en línea, tu salud es nuestra prioridad', group: 'Banda salud' },
  { key: 'abarrotesSafetySubtitle', label: 'Banda salud: subtítulo', placeholder: 'Cuidamos cada producto con los más altos estándares...', group: 'Banda salud' },
  { key: 'abarrotesCardOneLabel', label: 'Tarjeta 1: etiqueta', placeholder: 'Solo por hoy', group: 'Tarjetas inferiores' },
  { key: 'abarrotesCardOneTitle', label: 'Tarjeta 1: título', placeholder: 'Te damos los productos de mejor calidad', group: 'Tarjetas inferiores' },
  { key: 'abarrotesCardOneButton', label: 'Tarjeta 1: botón', placeholder: 'Comprar ahora', group: 'Tarjetas inferiores' },
  { key: 'abarrotesCardTwoLabel', label: 'Tarjeta 2: etiqueta', placeholder: 'Esta semana', group: 'Tarjetas inferiores' },
  { key: 'abarrotesCardTwoTitle', label: 'Tarjeta 2: título', placeholder: 'Hacemos tu compra más entretenida', group: 'Tarjetas inferiores' },
  { key: 'abarrotesCardTwoButton', label: 'Tarjeta 2: botón', placeholder: 'Comprar ahora', group: 'Tarjetas inferiores' },
  { key: 'abarrotesCardThreeLabel', label: 'Tarjeta 3: etiqueta', placeholder: 'Solo por hoy', group: 'Tarjetas inferiores' },
  { key: 'abarrotesCardThreeTitle', label: 'Tarjeta 3: título', placeholder: 'El supermercado que te hace ahorrar', group: 'Tarjetas inferiores' },
  { key: 'abarrotesCardThreeButton', label: 'Tarjeta 3: botón', placeholder: 'Comprar ahora', group: 'Tarjetas inferiores' },
  { key: 'abarrotesOcultarEnvio', label: 'Ocultar costo de envío', placeholder: '', group: 'Checkout', type: 'toggle', hint: 'Oculta la línea "Envío" y el mensaje de delivery gratis en el checkout.' },
  { key: 'abarrotesContactHeading', label: 'Contacto: título de portada', placeholder: 'Estamos para ayudarte', group: 'Contacto' },
  { key: 'abarrotesContactSubheading', label: 'Contacto: subtítulo de portada', placeholder: '¿Tienes una consulta sobre tu pedido?...', group: 'Contacto' },
  { key: 'abarrotesContactTitle', label: 'Contacto: título del formulario', placeholder: 'Escríbenos', group: 'Contacto' },
  { key: 'abarrotesContactSubmitLabel', label: 'Contacto: botón enviar', placeholder: 'Enviar mensaje', group: 'Contacto' },
  { key: 'abarrotesContactAddress', label: 'Contacto: dirección', placeholder: 'Av. Principal 123, Lima', group: 'Contacto' },
  { key: 'abarrotesContactPhone', label: 'Contacto: teléfono', placeholder: '+51 999 999 999', group: 'Contacto' },
  { key: 'abarrotesContactEmail', label: 'Contacto: correo', placeholder: 'hola@grogin.pe', group: 'Contacto' },
  { key: 'abarrotesContactHours', label: 'Contacto: horario', placeholder: 'Lun a Dom · 8:00 – 22:00', group: 'Contacto' },
...
const ABARROTES_LINK_FIELDS: LinkFieldDef[] = [
  { key: 'abarrotesHeroAction', label: 'Slide 1: enlace (banner y botón)', group: 'Slider · Slide 1', defaultType: 'catalog' },
  { key: 'abarrotesSlide2Action', label: 'Slide 2: enlace (banner y botón)', group: 'Slider · Slide 2', defaultType: 'catalog' },
  { key: 'abarrotesSlide3Action', label: 'Slide 3: enlace (banner y botón)', group: 'Slider · Slide 3', defaultType: 'catalog' },
  { key: 'abarrotesPromoOneAction', label: 'Banner promo 1: enlace', group: 'Banner promo', defaultType: 'catalog' },
  { key: 'abarrotesPromoTwoAction', label: 'Banner promo 2: enlace', group: 'Banner promo', defaultType: 'catalog' },
];

const SUPERMERCADO_IMAGE_FIELDS: ImageFieldDef[] = [
  { key: 'supermercadoHeroImage', label: 'Slider · Slide 1: imagen', hint: 'Imagen del primer slide del hero (canasta/producto). Recomendado 800×800px.', fallback: 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=600&q=80' },
...
const SUPERMERCADO_TEXT_FIELDS: TextFieldDef[] = [
  ...
  { key: 'supermercadoHeroTitle2', label: 'Slide 1: título (línea 2, color)', placeholder: 'mejor vida', group: 'Slider · Slide 1' },
  { key: 'supermercadoHeroSubtitle', label: 'Slide 1: subtítulo', placeholder: 'Recibe las frutas, verduras y esenciales más frescos...', group: 'Slider · Slide 1' },
  { key: 'supermercadoHeroBadge', label: 'Slide 1: badge circular', placeholder: 'Hasta 30% OFF', group: 'Slider · Slide 1' },
  { key: 'supermercadoHeroButton', label: 'Slide 1: botón principal', placeholder: 'Comprar ahora', group: 'Slider · Slide 1' },
  { key: 'supermercadoHeroButton2', label: 'Slide 1: botón secundario', placeholder: 'Ver ofertas', group: 'Slider · Slide 1' },
  { key: 'supermercadoSlide2OnlyImage', label: 'Slide 2: solo imagen', placeholder: '', group: 'Slider · Slide 2', type: 'toggle', hint: 'Banner de solo imagen clickeable al destino del Slide 2.' },
  { key: 'supermercadoSlide2Eyebrow', label: 'Slide 2: etiqueta', placeholder: 'Directo del campo', group: 'Slider · Slide 2' },
  { key: 'supermercadoSlide2Title', label: 'Slide 2: título (línea 1)', placeholder: 'Frutas y verduras', group: 'Slider · Slide 2' },
  { key: 'supermercadoSlide2Title2', label: 'Slide 2: título (línea 2, color)', placeholder: 'del día', group: 'Slider · Slide 2' },
  { key: 'supermercadoSlide2Subtitle', label: 'Slide 2: subtítulo', placeholder: 'Seleccionamos lo mejor de cada cosecha...', group: 'Slider · Slide 2' },
  { key: 'supermercadoSlide2Badge', label: 'Slide 2: badge circular', placeholder: 'Nuevo ingreso', group: 'Slider · Slide 2' },
  { key: 'supermercadoSlide2Button', label: 'Slide 2: botón principal', placeholder: 'Descubrir', group: 'Slider · Slide 2' },
  { key: 'supermercadoSlide2Button2', label: 'Slide 2: botón secundario', placeholder: 'Ver todo', group: 'Slider · Slide 2' },
  { key: 'supermercadoSlide3OnlyImage', label: 'Slide 3: solo imagen', placeholder: '', group: 'Slider · Slide 3', type: 'toggle', hint: 'Banner de solo imagen clickeable al destino del Slide 3.' },
  { key: 'supermercadoSlide3Eyebrow', label: 'Slide 3: etiqueta', placeholder: 'Entrega en 30 minutos', group: 'Slider · Slide 3' },
  { key: 'supermercadoSlide3Title', label: 'Slide 3: título (línea 1)', placeholder: 'Tu despensa llena,', group: 'Slider · Slide 3' },
  { key: 'supermercadoSlide3Title2', label: 'Slide 3: título (línea 2, color)', placeholder: 'sin salir de casa', group: 'Slider · Slide 3' },
  { key: 'supermercadoSlide3Subtitle', label: 'Slide 3: subtítulo', placeholder: 'Haz tu pedido y recíbelo el mismo día...', group: 'Slider · Slide 3' },
  { key: 'supermercadoSlide3Badge', label: 'Slide 3: badge circular', placeholder: 'Envío gratis', group: 'Slider · Slide 3' },
  { key: 'supermercadoSlide3Button', label: 'Slide 3: botón principal', placeholder: 'Pedir ahora', group: 'Slider · Slide 3' },
  { key: 'supermercadoSlide3Button2', label: 'Slide 3: botón secundario', placeholder: 'Ver ofertas', group: 'Slider · Slide 3' },
  { key: 'supermercadoCategoriesTitle', label: 'Título "Compra por categoría"', placeholder: 'Compra por categoría', group: 'Secciones' },
  { key: 'supermercadoDealsTitle', label: 'Título "Ofertas del día"', placeholder: 'Ofertas del día', group: 'Secciones' },
  { key: 'supermercadoWhyTitle', label: 'Título "¿Por qué elegirnos?"', placeholder: '¿Por qué elegirnos?', group: 'Secciones' },
  { key: 'supermercadoTestimonialsTitle', label: 'Título testimonios', placeholder: 'Lo que dicen nuestros clientes', group: 'Secciones' },
  { key: 'supermercadoSaverLabel', label: 'Súper ahorro: etiqueta', placeholder: 'Oferta por tiempo limitado', group: 'Banner ahorro' },
  { key: 'supermercadoSaverTitle', label: 'Súper ahorro: título', placeholder: 'Súper ahorro del fin de semana', group: 'Banner ahorro' },
  { key: 'supermercadoSaverSubtitle', label: 'Súper ahorro: subtítulo', placeholder: 'Hasta 30% de descuento en productos seleccionados...', group: 'Banner ahorro' },
  { key: 'supermercadoSaverButton', label: 'Súper ahorro: botón', placeholder: 'Comprar ahora', group: 'Banner ahorro' },
  { key: 'supermercadoNewsletterTitle', label: 'Newsletter: título', placeholder: 'Recibe ofertas exclusivas', group: 'Newsletter' },
  { key: 'supermercadoNewsletterSubtitle', label: 'Newsletter: subtítulo', placeholder: 'Suscríbete y recibe las mejores ofertas...', group: 'Newsletter' },
  { key: 'supermercadoNewsletterButton', label: 'Newsletter: botón', placeholder: 'Suscribirme', group: 'Newsletter' },
  { key: 'supermercadoOcultarEnvio', label: 'Ocultar costo de envío', placeholder: '', group: 'Checkout', type: 'toggle', hint: 'Oculta la línea "Envío" y el mensaje de delivery gratis en el checkout.' },
  { key: 'supermercadoContactHeading', label: 'Contacto: título de portada', placeholder: 'Estamos para ayudarte', group: 'Contacto' },
  { key: 'supermercadoContactSubheading', label: 'Contacto: subtítulo de portada', placeholder: '¿Tienes una consulta sobre tu pedido?...', group: 'Contacto' },
  { key: 'supermercadoContactTitle', label: 'Contacto: título del formulario', placeholder: 'Escríbenos', group: 'Contacto' },
  { key: 'supermercadoContactSubmitLabel', label: 'Contacto: botón enviar', placeholder: 'Enviar mensaje', group: 'Contacto' },
  { key: 'supermercadoContactAddress', label: 'Contacto/Header: dirección', placeholder: 'Av. Principal 123, Lima', group: 'Contacto' },
  { key: 'supermercadoContactPhone', label: 'Contacto/Header: teléfono', placeholder: '+51 999 999 999', group: 'Contacto' },
  { key: 'supermercadoContactEmail', label: 'Contacto: correo', placeholder: 'hola@freshmart.pe', group: 'Contacto' },
  { key: 'supermercadoContactHours', label: 'Contacto/Header: horario', placeholder: 'Lun a Dom · 8:00 – 22:00', group: 'Contacto' },
...
const SUPERMERCADO_LINK_FIELDS: LinkFieldDef[] = [
  { key: 'supermercadoHeroAction', label: 'Slide 1: enlace (banner y botón)', group: 'Slider · Slide 1', defaultType: 'catalog' },
  { key: 'supermercadoSlide2Action', label: 'Slide 2: enlace (banner y botón)', group: 'Slider · Slide 2', defaultType: 'catalog' },
  { key: 'supermercadoSlide3Action', label: 'Slide 3: enlace (banner y botón)', group: 'Slider · Slide 3', defaultType: 'catalog' },
];
...
export const LIVE_EDITOR_FIELDS: Record<string, LiveEditorPlantillaConfig> = {
  ...
  abarrotes: { textFields: ABARROTES_TEXT_FIELDS, imageFields: ABARROTES_IMAGE_FIELDS, productFields: [], linkFields: ABARROTES_LINK_FIELDS },
  supermercado: { textFields: SUPERMERCADO_TEXT_FIELDS, imageFields: SUPERMERCADO_IMAGE_FIELDS, productFields: [], linkFields: SUPERMERCADO_LINK_FIELDS },

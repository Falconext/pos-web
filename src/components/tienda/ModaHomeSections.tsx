...
const newArrivalFallback: ProductSeed[] = [
  ...
  ['Hoodie tejido oscuro', 'KREZKA', 89.9, 101, 'https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?auto=format&fit=crop&q=90&w=900'],
  ...
  ['Trench coat urbano', 'KREZKA', 189, 219, 'https://images.unsplash.com/photo-1512316609839-ce289d3eba0a?auto=format&fit=crop&q=90&w=900'],
];

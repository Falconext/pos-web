...
import MayeCompareWidget from './MayeCompareWidget';
import { mayeCard, mayePage, mayeSection, mayeStagger, mayeViewport } from '@/lib/motion/maye';
...
export default function MayeLayout({
  ...
  return (
    <motion.div className="min-h-screen bg-white" style={{ fontFamily: `'${diseno.tipografia || 'Inter'}', sans-serif` }} variants={mayePage} initial="initial" animate="animate" exit="exit">
      ...
      <MayeCompareWidget slug={slug} cp={cp} onGoProduct={goProduct} />

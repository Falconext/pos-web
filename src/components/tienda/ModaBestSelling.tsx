...
const hombreFallback: Array<[string, string, number, number, string]> = [
  ...
  ['Casaca urbana minimal', 'KREZKA', 129, 138, 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&q=90&w=900'],
];
...
const mujerFallback: Array<[string, string, number, number, string]> = [
  ...
  ['Vestido largo noche', 'KREZKA', 179, 198.1, 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?auto=format&fit=crop&q=90&w=900'],
];

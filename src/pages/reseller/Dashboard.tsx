...
export default function ResellerDashboard() {
    ...
    useEffect(() => {
        if (auth?.resellerId) {
            console.log('Fetching dashboard for reseller:', auth.resellerId);
            getDashboard(auth.resellerId);
        } else {
            console.warn('No resellerId found in auth:', auth);
        }
    }, [auth]);
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {/* Costo Actual / Descuento */}
                <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-center gap-4 transition-transform hover:-translate-y-1 duration-300">
                    <div className="p-4 bg-purple-50 text-purple-600 rounded-2xl">
                        <Icon icon="solar:tag-price-bold-duotone" width="32" />
                    </div>
                    <div>
                ...
                <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-center gap-4 transition-transform hover:-translate-y-1 duration-300">
                    <div className="p-4 bg-red-50 text-red-600 rounded-2xl">
                        <Icon icon="solar:user-block-bold-duotone" width="32" />
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="text-sm text-gray-600">
                                {/* Placeholders or real data mapping later */}
                                <tr>
                                    <td className="py-8 text-center text-gray-400" colSpan={4}>
                                        Por ahora no hay actividad reciente.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl p-6 text-white shadow-lg shadow-indigo-500/30">
                    ...
                    <div className="space-y-4">
                        <button className="w-full py-3 bg-white text-indigo-700 font-bold rounded-xl shadow-sm hover:shadow-md transition-all active:scale-95">
                            Contactar Soporte
                        </button>

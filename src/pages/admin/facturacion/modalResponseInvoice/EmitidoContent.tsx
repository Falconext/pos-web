        ...
        <>
            <div className="flex flex-col">
                ...
                <div className={`px-6 pt-7 pb-5 flex flex-col items-center gap-3 text-center border-b ${isDarkMode ? 'border-slate-800' : 'border-gray-100'}`}>
                    <p className="text-[10px] uppercase tracking-[0.25em] text-gray-400 font-medium">{isUpdate ? 'Comprobante actualizado' : 'Comprobante emitido'}</p>
                            ...
                            {FORMATOS_IMPRESION_INFO.map(({ value, icon, label, sub }) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {esDefault ? (
                                            <span className={`px-1.5 py-0.5 rounded-full text-[8px] font-bold uppercase tracking-wide leading-none ${

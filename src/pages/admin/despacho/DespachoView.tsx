                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="relative top-2 h-10 px-3 flex items-center gap-1.5 rounded-xl bg-fuchsia-600 text-white hover:bg-fuchsia-700 transition-colors text-xs font-black disabled:opacity-60"

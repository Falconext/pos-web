...
import PrintPDF from "../facturacion/print";
...
import ComprobantePrintPage from "../facturacion/comprobanteImprimir";
import { useReactToPrint } from "react-to-print";
import ModalEnviarWhatsApp from "../facturacion/ModalEnviarWhatsApp";
        ...
        <div className="min-h-screen pb-4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Gestiona tus presupuestos
